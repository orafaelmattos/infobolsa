    ...
    return (
        <div className='container'>
            ...
            <div className="card-container">
                ...
                <div className='cards'>
                    <div className='card-border' onClick={() => handleCardClick('/bolsa')}>
                        <div className='card'>
                    ...
                    <div className='card-border' onClick={() => handleCardClick('/cotacao')}>
                        <div className='card'>
                            <div className='card-image'>
                                <h1><PiMoney /></h1>
                            </div>
                            ...
                            <div className='card-info'>
                                ...
                                <div className='card-variation'>
                                    <p>R$ {data?.currencies?.USD.buy.toFixed(2)}</p>
                    ...
                    <div className='card-border' onClick={() => handleCardClick('/cripto')}>
                        <div className='card'>
                            <div className='card-image'>
                                <h1><RiBitCoinLine /></h1>
                            </div>
